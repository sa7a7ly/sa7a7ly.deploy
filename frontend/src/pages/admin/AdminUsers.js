        ...
        <div className="relative flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-base leading-relaxed text-slate-700">
              We are a web app that helps students and teachers make life easier.
              We simplify assignments so students can work smarter and achieve higher grades.
            </p>
          ...
          <div className="grid w-full max-w-sm grid-cols-2 gap-4 text-center">
            <div className="rounded-2xl border border-slate-200 bg-white/80 p-4 shadow-sm">
              <p className="text-2xl font-bold text-slate-900">2x</p>
